...
import com.bolddevoteam.adidaschallenge.core.R
...
fun DataPoint.toPhysicalActivityItem(context: Context): PhysicalMoves {
    ...
    return PhysicalMoves(activityName, icon, startTime, endTime)
}
...
fun checkGoogleFitPermissions(fitnessOptions: GoogleSignInOptionsExtension, context: Context?) = GoogleSignIn.hasPermissions(GoogleSignIn.getLastSignedInAccount(context), fitnessOptions)