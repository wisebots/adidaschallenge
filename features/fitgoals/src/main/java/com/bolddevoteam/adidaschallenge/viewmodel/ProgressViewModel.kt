...
import com.bolddevoteam.adidaschallenge.core.commons.AppExecutors
import com.bolddevoteam.adidaschallenge.core.data.AppUsage
import com.bolddevoteam.adidaschallenge.core.data.CombinedLiveData
import com.bolddevoteam.adidaschallenge.core.data.PhysicalMoves
import com.bolddevoteam.adidaschallenge.core.data.TimelineItem
import com.bolddevoteam.adidaschallenge.core.extensions.addToCompositeDisposable
import com.bolddevoteam.adidaschallenge.fitgoals.model.repository.Repository
...
class ProgressViewModel (application: Application) : AndroidViewModel(application), CoroutineScope {
    ...
    private val _physicalActivityItems = MutableLiveData<List<PhysicalMoves>>()
    ...
    private var _combinedItemsList: CombinedLiveData<List<AppUsage>, List<PhysicalMoves>, List<TimelineItem>>
        ...
        repository.getPhysicalActivities(dataReadRequest, historyClient, context)
            ...
            .doOnSuccess { list ->
                ...
                if (!list.isEmpty()) {
                    val time = list
                        .asSequence()
                        .filter { physicalMoves -> physicalMoves.name.toLowerCase() != "still" }
                        .map { physicalMoves ->
                            physicalMoves._endTime - physicalMoves._startTime
                        }
                        .reduce { acc, l -> acc + l }
